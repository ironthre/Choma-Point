...
<body data-spy="scroll" data-target="#template-navbar">
                    ...
                    <div class="col-xs-12 col-sm-6 dis-table-cell">
                        <div class="section-content">
                            ...
                            <p class="section-content-para">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quia harum possimus saepe eius
                                aliquam hic aliquid excepturi veritatis nobis consequatur.

                            </p>
                            <p class="section-content-para">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit, nulla eveniet laudantium
                                quibusdam totam id dolor saepe repellat quis, quae neque aut dolores dicta, amet quod.
                                Magnam laborum neque cumque.
                            </p>
                        </div> <!-- /.section-content -->
                    </div>
                </div> <!-- /.row -->
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="menu-system">
                                    <h2 class="pricing-title">Menue List in Affordable Pricing</h2>
                                ...
                                <li class="item" id="{{ $item->category->slug }}">
                                    ...
                                    <a href="#">
                                        <img src="{{ asset('uploads/item/' . $item->image) }}" class="img-responsive"
                                            alt="Food" style="height:300px; width: 350px;">
                                    ...
                                    <h2 class="white">{{ $item->price }} TZS</h2>
                                </li>
                            @endforeach
    ...
    <section id="reserve" class="reserve">
        ...
        <div class="wrapper">
            <div class="container-fluid">
                <div class="row dis-table">
                    <div class="col-xs-6 col-sm-6 dis-table-cell color2-bg">
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-6">
                            <form class="reservation-form" method="post"
                                action="{{ route('reservation.reserve') }}">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <textarea type="text" name="message" class="form-control reserve-form empty iconified" id="message"
                                            rows="3" required="required" placeholder="  &#xf086;  We're listening"></textarea>
                                    </div>
    ...
    <section id="contact" class="contact">
        <div class="container-fluid color3-bg">
            <div class="row dis-table">
                ...
                <div class="col-xs-6 col-sm-6 dis-table-cell">
                    <div class="section-content">
                        <p>Tanzania, Dar es salaam, Kigamboni</p>
                        <p>0743289196</p>
                        <p>athmaniathmani4@gmail.com </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                    <div class="row">
                        <form class="contact-form" method="post" action="{{ route('contact.send') }}">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <textarea name="message" type="text" class="form-control" id="message" rows="7" required="required"
                                    placeholder="  Message"></textarea>
                            </div>

                            <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                                <div class="text-center">
                                    <button type="submit" id="submit" name="submit" class="btn btn-send">Send
                                    </button>
                                </div>
                            </div>
                        </form>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="copyright text-center">
                        <p>
                            &copy; Copyright 2022. Choma Point Management System. All Rights Reserved.</a>
                        </p>
                    </div>
                </div>
            </div>
